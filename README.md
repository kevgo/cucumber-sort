...
The recipe is technically correct. But it would be easier to reason about and
compare it to other recipes if we always specified the base dough first, and
then add the additional ingredients like fruits and spices.
